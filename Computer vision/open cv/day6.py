...
cv2.waitKey(0)
image_modified_blurred=cv2.blur(image,(9,9))
cv2.imshow("Image blurrend second type",image_blurred)
cv2.waitKey(0)
image3_blurred=cv2.medianBlur(image,9)
cv2.imshow("Blurred with medianBlur",image3_blurred)
cv2.waitKey(0)